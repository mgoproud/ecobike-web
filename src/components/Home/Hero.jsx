...
const Hero = () => {
  return (
    ...
    <div className="bg-brandLight/80 rounded-lg">
        <div className="container min-h-[86vh] md:min-h-[680px] grid grid-cols-1 sm:grid-cols-2 gap-3 place-items-center place-content-start md:place-content-center p-3 lg:px-10">
            {/* text */}
