...
const Hero = () => {
  return (
    ...
    <div className="bg-brandLight/80 rounded-lg">
        <div className="container min-h-[100vh] md:min-h-[680px] grid grid-cols-1 sm:grid-cols-2 gap-5 place-items-center place-content-start p-5 lg:px-10">
            {/* text */}
            ...
            <div className='relative z-30 order-1 sm:order-2 bg-white/70 mt-3 w-fit' >
                <img 
                    src={hero1} 
                    alt="hero_img" 
                    className='p-3 max-h-[320px] md:max-h-[380px] lg:max-h-[440px] w-auto lg:scale-100 lg:translate-4' 
                    />
            </div>
        </div>
    </div>
